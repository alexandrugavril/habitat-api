...
def main():
    ...
    parser.add_argument(
        "--task-config", type=str, default="configs/tasks/pointnav_replica_rgbd.yaml"
    )
    ...
    agent_config['SIMULATOR'] = config.SIMULATOR
    config.defrost()
    make_good_config_for_orbslam2(agent_config)
